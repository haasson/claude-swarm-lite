...
Заодно под рукой то, за чем обычно приходится лезть в соседнее окно: **ветка и правки** папки активной вкладки с диффом по клику, **команды и скиллы проекта** списком с поиском, **полоска контекста** на карточке — видно, кого пора сжимать.
