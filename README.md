...
| | |
|---|---|
| **[Пульт](#когда-ждут-несколько)** | Если ответа ждут сразу несколько агентов, Пульт выстраивает их в очередь с таймерами. Вы отвечаете одному, и он сам переключается на следующего. |
| **[Ответ из Telegram](#telegram)** | Тема в группе на каждую вкладку. Вы можете написать агенту с телефона, а разрешение дать кнопкой — в сообщении видно команду, которую вы одобряете. |
| **[Голосом](#что-можно-из-чата)** | Надиктуйте голосовое вместо того, чтобы печатать в дороге. Распознаётся на вашем компьютере, звук никуда не уходит. |
| **[Скриншотом](#что-можно-из-чата)** | Пришлите картинку в чат, и агент посмотрит её сам. Быстрее, чем пересказывать пальцами красную простыню из терминала. |
| **[Ветка и правки](#ветка-и-правки)** | Внизу окна — ветка папки активной вкладки, дифф по клику и переключение веток, не выходя из приложения. |
| **[Команды проекта](#команды-проекта)** | Slash-команды и скиллы вашего проекта Swarm находит сам и показывает списком с поиском. |
| **[Контекст и лимиты](#сколько-осталось-контекста)** | Полоска на карточке показывает, у кого кончается контекст, а `/usage` — расход окон подписки на 5 часов и на неделю. |
| **[Сессии возвращаются](#настроить-под-себя)** | После перезапуска каждая вкладка может вернуться в свой разговор, а не начать с чистого листа. |
| **[Свой вид](#настроить-под-себя)** | Тема и шрифт терминала, две раскладки списка вкладок, плотность карточек и что на них показывать. |
