...
## Не вы проверяете агентов — они зовут вас

Вкладки есть в любом терминале, дело не в них.

Дело в том, что начинается на третьем агенте. Они работают молча, и вы становитесь диспетчером: прыгаете по вкладкам и смотрите, не спросил ли кто-нибудь разрешения, не упёрся ли в вопрос, не закончил ли пятнадцать минут назад. Один встал через минуту после старта и всё это время ждал вас. Другой доделал и простаивает. Узнать об этом можно только заглянув.

Swarm разворачивает это в другую сторону. Кому вы нужны — тот и подаёт голос:

| | |
|---|---|
| **Вкладка красится сама** | Оранжевая работает, бирюзовая ждёт вашего ответа, зелёная закончила. Заглядывать не нужно — видно из списка. |
| **Уведомление в системе** | Агент в фоне упёрся в вопрос — прилетает уведомление, клик по нему открывает эту вкладку. |
| **Пульт собирает очередь** | Если вас ждут сразу четверо, Пульт выстраивает их в ряд: вы отвечаете одному, и он сам переключается на следующего. |
| **Telegram, когда вас нет** | Тема на каждую вкладку. Вы можете написать текстом или голосовым, а разрешение дать кнопкой. |
...
Заодно под рукой то, за чем обычно лезешь в соседнее окно: **ветка и правки** папки активной вкладки с диффом по клику, **команды и скиллы проекта** списком с поиском, **полоска контекста** на карточке — видно, кого пора сжимать.
