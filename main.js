...
//
//   desk  «за компом»    — телефон молчит. Ты сидишь перед этими вкладками и всё видишь
//                          сам; жужжать над каждым вопросом, пока человек смотрит на него
//                          в упор, — это не забота, а помеха.
...
//
// Молчание касается только того, что мост затевает САМ. На спрошенное из чата он отвечает
// всегда: команды работают, и ответ на отправленное с телефона сообщение приходит, где бы
// ты ни был, — иначе «получил, думаю…» осталось бы с часиками навсегда.
//
...
const TG_PRESENCE_SAID = {
  desk: 'за компом — сам в группу не пишу, только отвечаю на спрошенное',
