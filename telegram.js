...
const QA_PREFIX = 'q';
// Подписи обязаны называть ЦЕНУ нажатия, поэтому «правки» и «без вопросов» — разные кнопки:
// в живом Claude Code это разные режимы (accept edits разрешает только правки, auto не
// спрашивает вообще ни о чём), и обещать одно, делая другое, тут нельзя.
const QA_ACTIONS = {
  status: 'что сейчас',
  edits: '✍️ правки без спроса',
  auto: '⚡ вообще без вопросов',
