...
function systemPromptRule(phrases) {
  ...
  return [
    'Ты работаешь внутри Claude Swarm Lite: пользователь видит статус этой вкладки со стороны',
...
function claudeMdRule(phrases) {
  ...
  return [
    ...
    '## Как звать меня',
    '',
    'Я смотрю на агентов через Claude Swarm Lite: каждая вкладка показывает статус, и я могу быть',
